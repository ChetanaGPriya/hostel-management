...
$stmt->execute();
echo"<script>alert('Due has been added successfully');</script>";
}
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Add Dues </h2>
	
						<div class="row">
							<div class="col-md-12">
								<div class="panel panel-default">
									<div class="panel-heading">Add Dues</div>
...
<div class="form-group">
									<label class="col-sm-2 control-label">Upto(dd-mm-yyyy):</label>
									<div class="col-sm-8">
									<input type="text" class="form-control" name="cnf" value="" >
												...
												<div class="col-sm-8 col-sm-offset-2">
													...
													<input class="btn btn-primary" type="submit" name="submit" value="Add due">
												</div>
											</div>
