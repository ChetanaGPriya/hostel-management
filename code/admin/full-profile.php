			...
			<tr>
			  <td colspan="2"  class="font1"><table width="100%" border="0">
                <tr>
                  ...
                  <tr>
                  <td width="22%" valign="top" class="heading">No. of Persons : </td>
                  
                      <td class="comb-value1"><span class="comb-value"><?php echo $row['seater'];?></span></td>
                    </tr>
                  
                    <tr>
                    <td width="12%" valign="top" class="heading">Fees Per Student: </td>
...
else
{
  echo "With Food";
                    ...
                    <tr>
                    <td width="12%" valign="top" class="heading">Admission Date: </td>
                      <td class="comb-value1"><?php echo $row['stayfrom'];?></td>
                    </tr>
                    <tr>
                    <td width="12%" valign="top" class="heading">Academic Year: </td>
...
<tr>
<td width="12%" valign="top" class="heading">Year of Study: </td>
